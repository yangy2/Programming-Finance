...
void fill_matrix(vector<vector<int>>&A, int rows, int cols) //read user input for matrix elements
{
...
void print_matrix(vector<vector<int>>&A, int rows, int cols) //print contents of matrix
{
	for (int i = 0; i < rows; i++)
	{
		cout << "\t\t";
...
void add(vector<vector<int>>&A, vector<vector<int>>&B, vector<vector<int>>&C, int rows, int cols) //matrix addition
{
	for (int i = 0; i < rows; i++)
	{
		for (int j = 0; j < cols; j++)
...
void sub(vector<vector<int>>&A, vector<vector<int>>&B, vector<vector<int>>&C, int rows, int cols) //matrix subtraction
{
	for (int i = 0; i < rows; i++)
	{
		for (int j = 0; j < cols; j++)
...
void mult(vector<vector<int>>&A, vector<vector<int>>&B, vector<vector<int>>&C, int a_rows, int a_cols, int b_rows, int b_cols) //matrix multiplication
{
...
void trans(vector<vector<int>>&A, vector<vector<int>>&C, int rows, int cols) //matrix transpose
{
	for (int j = 0; j < cols; j++)
	{
		for (int i = 0; i < rows; i++)
...
int det(vector<vector<int>>&A) //matrix determinant
{
...
void inv(vector<vector<int>>&A, int rows, int cols) //matrix inversion
{
